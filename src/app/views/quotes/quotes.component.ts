...
export class QuotesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    var per_page_limit = localStorage.getItem('quotes_module_limit');
    var selected_order_dir = localStorage.getItem('quotes_module_order_dir');
    var selected_order_by = localStorage.getItem('quotes_module_order_by');
    var selected_page_no = localStorage.getItem('quotes_module_page_count');
    var search_keyword = localStorage.getItem('quotes_module_search_keyword');
      ...
      .pipe(
        ...
        tap(data => {
          if (!deepEqual(this.filter, data)) {
            if(data.search != ""){
              localStorage.setItem("quotes_module_search_keyword", data.search);
            }else{
              localStorage.removeItem("quotes_module_search_keyword");
            }
  ...
  onPaginateChange(event) {
    ...
    localStorage.setItem('quotes_module_limit', event.pageSize);
    localStorage.setItem('quotes_module_page_count', data.page);
