...
//#region Get List
export const GET_LIST = '@lc/cmsuserlogs/get-list';
...
export const GET_LIST_SUCCESS = '@lc/cmsuserlogs/get-list-success';
...
export const UPDATE_FILTER = '@lc/cmsuserlogs/update-filter';
...
//#region Update Meta
export const UPDATE_META = '@lc/cmsuserlogs/update-meta';
...
//#region Add Error
export const ADD_ERROR = '@lc/cmsuserlogs/add-error';
...
//#region Clear Detail
export const CLEAR_DETAIL = '@lc/cmsuserlogs/clear-detail';
